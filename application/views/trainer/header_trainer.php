...
<head>
<title>Trainer Control Panel</title><meta charset="UTF-8" />
...
<div id="sidebar"><a href="<?php echo base_url(); ?>index.php/trainer" class="visible-phone"><i class="icon icon-home"></i> Home</a>
  <ul>
    <li class="active"><a href="<?php echo base_url(); ?>index.php/trainer"><i class="icon icon-home"></i> <span>Home</span></a> </li>
    <li> <a href="<?php echo base_url(); ?>index.php/Trainer_editions"><i class="icon icon-calendar"></i> <span>My Editions</span></a> </li>
    <!-- <li> <a href="widgets.html"><i class="icon icon-book"></i> <span>Formadores</span></a> </li> -->
    <li><a href="<?php echo base_url(); ?>index.php/Trainer_part"><i class="icon icon-user"></i> <span>My Participants</span></a></li>
