						  ...
						  case '3':
							  ...
							  foreach($query->result_array() as $row){
									...
									echo '<tr>
					                  ...
					                  <th><h5>'.$row['ed_fecha1'].'</h5><a href="'.base_url().'index.php/Part_list_con/cambiar_asistencia_all_dia1/'.$ref_curso.'"><button class="btn-success btn_mini" style="margin-left:3%">Change All</button></a></th>
					                  
					                  <th><h5>'.$row['ed_fecha2'].'</h5><a href="'.base_url().'index.php/Part_list_con/cambiar_asistencia_all_dia2/'.$ref_curso.'"><button class="btn-success btn_mini" style="margin-left:3%">Change All</button></a></th>
					                  
					                  <th><h5>'.$row['ed_fecha3'].'</h5><a href="'.base_url().'index.php/Part_list_con/cambiar_asistencia_all_dia3/'.$ref_curso.'"><button class="btn-success btn_mini" style="margin-left:3%">Change All</button></a></th>
									...
									foreach($query->result_array() as $row){
										...
										if(!$attendance1){
											...
											echo '<td style="text-align:center;">'.form_open(base_url().'index.php/Part_list_con/cambiar_asistencia_dia1');																	
												...
												echo form_submit('submit','NO', array('class'=>'btn btn-danger')).'</td>';
											echo form_close();
										}else{
											...
											echo '<td style="text-align:center;">'.form_open(base_url().'index.php/Part_list_con/cambiar_asistencia_dia1');																	
												...
												echo form_hidden('c_ref', $ref_curso, array('class'=>'span11', 'id'=>'c_ref', 'placeholder'=>'Referencia del Curso'));
												echo form_hidden('id_edi_part', $id_edi_part,array('class'=>'span11', 'id'=>'id_edi_part', 'placeholder'=>'Referencia'));
												echo form_submit('submit','YES', array('class'=>'btn btn-success')).'</td>';
											echo form_close();
										}
										if(!$attendance2){	
											// echo '<td style="text-align:center;"><i style="color:#00ff00;"class="icon icon-remove"></td>';
										...
										if(!$attendance3){	
											...
											echo '<td style="text-align:center;">'.form_open(base_url().'index.php/Part_list_con/cambiar_asistencia_dia3');																	
												...
												echo form_hidden('c_ref', $ref_curso, array('class'=>'span11', 'id'=>'c_ref', 'placeholder'=>'Referencia del Curso'));
												echo form_hidden('id_edi_part', $id_edi_part,array('class'=>'span11', 'id'=>'id_edi_part', 'placeholder'=>'Referencia'));
												echo form_submit('submit','NO', array('class'=>'btn btn-danger')).'</td></tr>';
											echo form_close();
											...
											echo '<td style="text-align:center;">'.form_open(base_url().'index.php/Part_list_con/cambiar_asistencia_dia3');																	
												...
												echo form_hidden('c_ref', $ref_curso, array('class'=>'span11', 'id'=>'c_ref', 'placeholder'=>'Referencia del Curso'));
												echo form_hidden('id_edi_part', $id_edi_part,array('class'=>'span11', 'id'=>'id_edi_part', 'placeholder'=>'Referencia'));
												echo form_submit('submit','YES', array('class'=>'btn btn-success')).'</td></tr>';
											echo form_close();
						  ...
						  case '2':
							  ...
							  foreach($query->result_array() as $row){
									...
									echo '<tr>
					                  <th>Name</th>
					                  <th>Email</th>					                  
					                  <th>'.$row['ed_fecha1'].'<br/><a href="'.base_url().'index.php/Part_list_con/cambiar_asistencia_all_dia1"><button class="btn-success btn_mini" style="margin-left:3%">Change All</button></a></th>
					                  
					                  <th>'.$row['ed_fecha2'].'<br/><a href="'.base_url().'index.php/Part_list_con/cambiar_asistencia_all_dia2"><button class="btn-success btn_mini" style="margin-left:3%">Change All</button></a></th>
          ...
          <div class="widget-content nopadding">
            <form action="<?php echo base_url() ?>index.php/Part_list_con/agregar_participante" method="post" class="form-horizontal"> 	
              ...
              <div class="control-group">
                ...
                <div class="controls">         
                  <?php echo form_textarea('comment', set_value('comment'), array('class'=>'span11', 'id'=>'comment', 'placeholder'=>'')); 
                  		echo form_hidden('c_ref', $ref_curso, array('class'=>'span11', 'id'=>'c_ref', 'placeholder'=>'Referencia del Curso'));?>
                </div>
              </div>
            ...
            <h5>Close Edition</h5>
          	...
          	<div class="widget-content">
          		<p style="text-align:center;margin-top:10%">
          			<strong>Please, click "SEND" button to confirm tha attendance and send the feedback forms to participants. (These will be send automatically)</strong>
          		</p>
          		<p style="text-align:center;"><a href="<?php echo base_url() ?>index.php/Email_att/index/<?php echo $ref_curso ?>"><button class="btn btn-info">SEND</button></a></p>
          	</div>
      	</div>
      </div>
	</div>
